...
const fixtures = {
  ...
  "/mini/regions": [
    { id: 1, name: "北京", normalized_name: "beijing", level: "city" },
    { id: 2, name: "全国", normalized_name: "country", level: "country" },
  ],
  "/mini/indicators": [
    { id: 1, code: "housing_price_mom", name: "房价环比" },
    { id: 2, code: "cpi_yoy", name: "CPI 同比" },
  ],
...
test("city page loads indicator cards from route options", async () => {
  ...
  assert.equal(cityPage.data.cards.length, 2);
